...
#export HISTTIMEFORMAT='+%F %T '  # Commented out since I source this on my Mac.
...
#if [ "$(type -t __git_ps1)" == "function" ] && [ ! -z "$PS1" ] && [ $EUID == 0 ]; then
#    PS1='\[\e[1;31m\]\h\[\e[1;34m\] \W$(__git_ps1 " (\[\e[4m\]%s\[\e[24m\])") \$\[\e[00m\] '
#elif [ "$(type -t __git_ps1)" == "function" ] && [ ! -z "$PS1" ]; then
#    PS1='\[\e[1;32m\]\u@\h\[\e[1;34m\] \W$(__git_ps1 " (\[\e[4m\]%s\[\e[24m\])") \$\[\e[00m\] '
#fi
